...
def domain_coloring(x, y, f, figsize=(12, 8), xlabel="Re", ylabel="Im", title=None, grid=False, cmap="hsv"):
    ...
    cbar.ax.set_yticklabels(
        ["$0$", "$\\frac{\\pi}{2}$", "$\\pi$", "$\\frac{3\\pi}{2}$", "$2\\pi$"], fontsize=16
    )
...
def domain_coloring_illuminated(
    x,
    y,
    f,
    a=0.5,
...
def plot_re_im(
    ...
    ax_re.plot_surface(x, y, f.real, linewidth=0, alpha=alpha, cstride=1, rstride=1, cmap=cmap)
